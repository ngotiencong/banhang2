          ...
          <div class="card card-primary">
            ...
            <div class="card-body">
              ...
              <div class="form-group">
                ...
                <input name="phone" required="" type="text" id="" class="form-control">
              </div>
              <div class="form-group">
                <label for="inputName">Email</label>
                <input name="email" required="" type="email" id="" class="form-control">
              </div>
              <div class="form-group">
                <label for="inputName">Địa chỉ</label>
                <input name="adress" required="" type="text" id="" class="form-control">
              </div>
               <div class="form-group">
